...
public class Project {
	...
	@Size(min = 4,max = 5,message = "please use 4 to 5 charecters for project identifier")
	/**
	...
	public Project(long id,
			...
			@NotBlank(message = "project identifier required") @Size(min = 4, max = 5, message = "please use 4 to 5 charecters for project identifier") String projectIdentifier,
