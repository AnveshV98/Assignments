...
public class EmployeeController {
	...
	public ModelAndView displayAllEmployees() {
		System.out.println("Employee Page Requested : All Users");
		ModelAndView mv = new ModelAndView();
	...
	public ModelAndView displayNewEmployeeForm() {
	...
	public ModelAndView saveNewUser(@ModelAttribute Employee employee, BindingResult result) {
		...
		if (isAdded) {
			mv.addObject("message", "New employee successfully added");
		} else {
			return new ModelAndView("error");
		}
	...
	public ModelAndView saveEditedUser(@ModelAttribute Employee employee, BindingResult result) {
		ModelAndView mv = new ModelAndView("redirect:/home");
